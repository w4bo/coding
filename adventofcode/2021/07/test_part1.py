...
class Test(unittest.TestCase):
    def test(self):
        self.assertEqual(f('data/07-test.txt'), 37)
        self.assertEqual(f('data/07-testb.txt'), 10)
        self.assertEqual(f('data/07-testa.txt'), 2)
        self.assertEqual(f('data/07-input.txt'), 341534)
